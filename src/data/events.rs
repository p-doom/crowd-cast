...
/// `1080 / px_height` (height-normalized; agent < 1.0.8 used
/// `1080 / min(px_width, px_height)`, identical for landscape displays).
...
pub struct MetadataEvent {
    ...
    /// `display_height`) shows this display's content scaled by `1080 / px_height` at the
    /// canvas origin (agent < 1.0.8: `1080 / min(px_width, px_height)`; identical for
    /// landscape displays).
    #[serde(default)]
